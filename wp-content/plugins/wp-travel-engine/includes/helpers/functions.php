...
function wte_get_the_trip_reviews( $trip_id = null ) {
	...
	<div class="wpte-trip-review-stars">
		...
		<span class="wpte-trip-review-count"><?php printf( esc_html( _n( '%d Review', '%d Reviews', $trip_reviews->count, 'wp-travel-engine' ) ), (float) $trip_reviews->count ); ?></span>
	</div>
	<?php
	return ob_get_clean();
	// phpcs:enable
