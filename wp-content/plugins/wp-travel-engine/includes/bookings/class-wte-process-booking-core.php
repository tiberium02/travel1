...
class Booking {
	...
	public static function create_payment( $booking_id, $meta_input = [], $type = 'full_payment' ) {
	...
	public function update_billing_info() {
		...
		update_post_meta( $this->booking->ID, 'billing_info', apply_filters( 'wte_before_update_billing_info', $billing, $this->booking ) );
	}
