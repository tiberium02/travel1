...
if ( isset( $facts['trip_facts'] ) && $facts['trip_facts'] != '' ) :
							...
							foreach ( $trip_facts['field_type'] as $key => $value ) {
								if ( isset( $wp_travel_engine_setting_option_setting['trip_facts']['fid'][ $key ] ) ) {
									...
									if ( isset( $wp_travel_engine_setting['trip_facts'][ $key ][ $key ] ) && ! empty( $wp_travel_engine_setting['trip_facts'][ $key ][ $key ] ) ) {
										...
										echo '<li><span class="icon-holder"><i class="' . esc_html($icon) . '"></i></span>';
										switch ( $value ) {
											case 'select':
 ...
 esc_html_e( ' day', 'wp-travel-engine' );}
							...
							if ( $trip_minimum_age ) :
								...
								?>
								<li><span class="icon-holder"><i class="<?php echo esc_attr($trip_minimum_age_icon); ?>"></i></span><div class="trip-facts-text">
							...
							if ( $trip_maximum_age ) :
								...
								?>
								<li><span class="icon-holder"><i class="<?php echo esc_attr($trip_maximum_age_icon); ?>"></i></span><div class="trip-facts-text">
