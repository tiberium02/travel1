					...
					?>
						<div class="wpte-repeater-block wpte-sortable wpte-trip-fact-row">
							<div class="wpte-field wpte-floated">
								...
								<input type="hidden" name="wp_travel_engine_setting[trip_facts][field_type][<?php echo esc_attr( $key ); ?>]" value="<?php echo esc_attr( $wp_travel_engine_option_settings['trip_facts']['field_type'][ $key ] ); ?>">
							<?php
							switch ( $value ) {
								case 'select':
								...
								case 'textarea';
									?>
												<textarea id="wp_travel_engine_setting[trip_facts][<?php echo esc_attr( $key ); ?>][<?php echo esc_attr( $key ); ?>]" name="wp_travel_engine_setting[trip_facts][<?php echo esc_attr( $key ); ?>][<?php echo esc_attr( $key ); ?>]" placeholder="<?php echo esc_attr( isset( $trip_facts['input_placeholder'][ $key ] ) ? $trip_facts['input_placeholder'][ $key ] : '' ); ?>" ><?php echo wp_kses_post( isset( $wp_travel_engine_setting['trip_facts'][ $key ][ $key ] ) ? $wp_travel_engine_setting['trip_facts'][ $key ][ $key ] : '' ); ?></textarea>
										<?php
										break;

								default:
									?>
									<input type="text" id="wp_travel_engine_setting[trip_facts][<?php echo esc_attr( $key ); ?>][<?php echo esc_attr( $key ); ?>]" name="wp_travel_engine_setting[trip_facts][<?php echo esc_attr( $key ); ?>][<?php echo esc_attr( $key ); ?>]" value="<?php echo isset( $wp_travel_engine_setting['trip_facts'][ $key ][ $key ] ) ? esc_attr( $wp_travel_engine_setting['trip_facts'][ $key ][ $key ] ) : ''; ?>" placeholder="<?php echo esc_attr( isset( $trip_facts['input_placeholder'][ $key ] ) ? esc_attr( $trip_facts['input_placeholder'][ $key ] ) : '' ); ?>">
									<?php
									break;
							}
							?>
